...
EXEC report.proc_insert_plant 'Agrofrancia – Extractora La Francia', null, 'C.A.', 'Guatemala', 'Izabal', 2011, 2012, 'Production', 'Planta de recepción, extracción, procesamiento y almacenamiento de aceite de palma africana.', 'IV','Rural', 'Km. 276 Carretera al Atlántico, Izabal, Guatemala, C.A.', null, null, 24;
EXEC report.proc_insert_plant 'Agrocentro', 'Agrocentro San Martín Plant', 'C.A.', 'Guatemala', 'Escuintla', null, 2014, 'Production', 'Production and distribution of crop protection products (herbicides, fungicides, insecticides and foliar fertilizers).', 'III','Rural', 'Microparcela 06 de la Finca La Esperanza, Escuintla, Guatemala C.A.', '14°12m55.11s', '90°45m28.44s', 165;
EXEC report.proc_insert_plant 'Palmas del Ixcán', 'Agroindustria Palmera San Román', 'C.A.', 'Guatemala', 'Peten', 2016, 2018, 'Production', 'Agroindustria Palmera San Román is an industrial plant dedicated to the extraction of African palm oil, palmiste (African palm walnut) oil and palmiste flour.', 'IV','Rural', 'Aldea Salinas, Municipio de Sayaxché, Petén, Guatemala, C.A.', '16°10m58.81s', '90°25m23.07s', 170;
EXEC report.proc_insert_plant 'Agroindustrias San Isidro, S.A.', null, 'C.A.', 'Guatemala', 'Escuintla', 2010, 2011, 'Production', 'Planta de producción de legumbres y hortalizas en invernaderos con sistema hidropónico.', 'I','Rural', 'Finca La Joya, Aldea La Unión, Guanagazapa, Escuintla, Guatemala, C.A.', '14°10m17.48s', '90°34m52.57s', 368;
EXEC report.proc_insert_plant 'Grupo AgroCaribe - AgroPalm.', null, 'N.A.', 'Mexico', 'Veracruz', 2005, 2015, 'Production', 'Planta industrial dedicada a la refinación de aceite RBD; sustracciones (oleínas y estearinas) y ácidos grasos.', 'IV','Industrial', 'Av. Quetzalcoatl s/n, Centro, Zona Franca, 96400 Coatzacoalcos, Veracruz, México', '18°07m52.58s', '94°25m10.12s', 7;
EXEC report.proc_insert_plant 'Agropecuaria Nuevo San Carlos', 'Palmas de Machaquila', 'C.A.', 'Guatemala', 'Peten', 2016, 2017, 'Production', 'Planta de recepción, extracción, procesamiento y almacenamiento de aceite de palma africana.', 'IV','Rural', 'Finca San Patricio, Sayaxché, Petén, Guatemala, C.A.', '16°08m31s', '89°56m38s', 130;
...
EXEC report.proc_insert_plant 'Almacenadora Guatemalteca, S.A.', null, 'C.A.', 'Guatemala', 'Guatemala', 1967, 1970, 'Storage', 'Empresa dedicada al almacenamiento de productos de empresas privadas, lideres en el diseño de soluciones logísticas y control de inventarios.', 'IV','Industrial', 'Avenida Petapa 36-55, zona 12. (Sede Central)', '14°34m54.66s', '90°32m44.82s', null;
EXEC report.proc_insert_plant 'Almacenadora Guatemalteca, S.A.', null, 'C.A.', 'Guatemala', 'Guatemala', 1967, 2001, 'Storage', 'Empresa dedicada al almacenamiento de productos de empresas privadas, lideres en el diseño de soluciones logísticas y control de inventarios.', 'IV','Industrial', 'Km. 5.5 Carretera al Atlántico, zona 17. (Anexo Zona 17)', '14°39m12.12s', '90°28m13.77s', null;
EXEC report.proc_insert_plant 'Almacenadora del País, S.A. Alpasa', null, 'C.A.', 'Guatemala', 'Guatemala', 1977, 1977, 'Storage', 'Warehousing of several goods for private held companies.', 'IV','Industrial, Commercial', 'Avenida Petapa 55-38, zona 12, Guatemala, Guatemala', '14°33m24.53s', '90°33m12.76s', 1415;
EXEC report.proc_insert_plant 'Envasadora de Alimentos y Conservas, S.A. - Ana Belly', null, 'C.A.', 'Guatemala', 'Sacatepequez', 2016, 2017, 'Production', 'Planta industrial dedicada a la producción de productos alimenticios (conservas, condimentos y aderezos).', 'I','Rural', 'Km. 46.8 Ruta Interamericana, Sumpango, Sacatepéquez, Guatemala', '14.6367', '-90.7539', 1805;
EXEC report.proc_insert_plant 'Arrocera Los Corrales - ALCSA -', null, 'C.A.', 'Guatemala', 'Guatemala', 1972, 1972, 'Production', 'Compra, procesamiento y comercialización de arroz blanco y pre-cocido, frijol y hojuela de avena.', 'I','Industrial, Residential, Commercial', 'Finca San Francisco, Villa Nueva, Guatemala, C.A.', '14°31m09.89s', '90°35m23.87s', null;
EXEC report.proc_insert_plant 'CAFCOM', null, 'C.A.', 'Guatemala', 'Escuintla', null, null, 'Production', 'Planta de acopio y almacenamiento de café pergamino, beneficio seco y despacho de café oro.', 'I','Rural', 'Carretera al Pacífico, entrada a San Vicente Pacaya, Palín, Escuintla, Guatemala, C.A.', null, null, null;
